...
<td align="center" style="padding:0;Margin:0;"> </td> 
   ...
   <br></p> </td> 
    ...
    <tr style="border-collapse:collapse;"> 
    <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;"> <p style="Margin:0;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">You have been selected to review {!! $mail_content['product'] !!}  by {!! $mail_content['sender'] !!}
   .</p> </td> 
    </tr> 
    <tr style="border-collapse:collapse;"> 
